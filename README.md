...
* **Back-End :** PHP 8 (programmation modulaire, sécurisation des formulaires, gestion des sessions et Base de donnée Oracle SQL).
...
Pendant ce projet j'ai notament appris à : 
...
Je n'aurais jamais pu écire cette application entière seule évidemment, un grand merci donc au memebre de mon groupe !
